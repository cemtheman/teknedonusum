...
def build_vessel_detail_analysis(
  ...
  if typical_hourly_specific_pv is not None:
    ...
    if specific_yield is not None:
      daily_solar_kwh = (
          installed_pv_kwp(spec) * float(specific_yield)
      )
    else:
      ...
      daily_solar_kwh = (
          solar_area_m2 * 0.15 * float(sun_hours)
      )
  ...
  analysis = VesselDetailAnalysis(
      ...
      season_solar_kwh=season_solar_kwh,
      season_grid_kwh=season_grid_kwh,
  ...
  finite_values = (
      ...
      analysis.season_solar_kwh,
      analysis.season_grid_kwh,
